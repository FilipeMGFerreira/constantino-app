...
export interface HabitanteDialogData {
  nome?: string;
  cor?: string;
}

@Component({
  selector: 'app-habitante-dialog',
  standalone: true,
  ...
  template: `
    <div class="ct-sheet">
      ...
      <p class="sub">Quem partilha despesas nesta casa.</p>
...
export class HabitanteDialogComponent {
  ref = inject(MatDialogRef<HabitanteDialogComponent, HabitanteDialogData | undefined>);
  data = inject<HabitanteDialogData>(MAT_DIALOG_DATA, { optional: true });
